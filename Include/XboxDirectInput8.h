...
namespace XboxControllerDirectInput
{
    ...
    private:
        ...
        // Hook for intercepting callbacks generated by a call to EnumDevices.
        static BOOL __stdcall CallbackEnumDevices(LPCDIDEVICEINSTANCE lpddi, LPVOID pvRef);

        // Hook for intercepting callbacks generated by a call to EnumDevicesBySemantics.
        static BOOL __stdcall CallbackEnumDevicesBySemantics(LPCDIDEVICEINSTANCE lpddi, LPDIRECTINPUTDEVICE8 lpdid, DWORD dwFlags, DWORD dwRemaining, LPVOID pvRef);
    };
}
