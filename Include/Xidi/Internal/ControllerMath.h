 ...
 *   Declaration and partial implementation of common mathematical operations
 *   for interpreting and transforming controller data.
 *****************************************************************************/
...
namespace Xidi
{
    namespace Controller
    {
        namespace Math
        {
            ...
            inline constexpr int16_t kAnalogPressedThresholdNegative = (kAnalogValueNeutral + kAnalogValueMin) / 3;

            /// Threshold positive direction value used to determine if an analog stick is considered "pressed" or not as a digital button.
            inline constexpr int16_t kAnalogPressedThresholdPositive = (kAnalogValueNeutral + kAnalogValueMax) / 3;
            ...
            int16_t ApplyRawAnalogTransform(int16_t analogValue, unsigned int deadzonePercent, unsigned int saturationPercent);

            /// Applies deadzone and saturation transformations to a raw trigger value.
            /// @param [in] analogValue Analog value for which a deadzone should be applied.
            /// @param [in] deadzoneHudnredthsOfPercent Hundredths of a percent of the analog range for which the deadzone should be applied.
            uint8_t ApplyRawTriggerTransform(uint8_t triggerValue, unsigned int deadzonePercent, unsigned int saturationPercent);
            ...
            constexpr inline bool IsAnalogPressedNegative(int16_t analogValue)
            {
            ...
            /// @param [in] analogValue Analog reading from the XInput controller.
            /// @return `true` if the virtual button is considered pressed, `false` otherwise.
            constexpr inline bool IsAnalogPressedPositive(int16_t analogValue)
            {
            ...
            /// @param [in] analogValue Analog reading from the XInput controller.
            /// @return `true` if the virtual button is considered pressed, `false` otherwise.
            constexpr inline bool IsAnalogPressed(int16_t analogValue)
            {
            ...
            /// @return `true` if the virtual button is considered pressed, `false` otherwise.
            constexpr inline bool IsTriggerPressed(uint8_t triggerValue)
            {
