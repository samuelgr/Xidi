...
namespace Xidi
{
    namespace Controller
    {
        ...
        /// Interface for communicating with physical controllers.
        /// Facilitates easier testing by enabling the physical controller interface to be mocked.
        ...
        public:
            ...
            virtual SPhysicalState GetCurrentState(TControllerIdentifier controllerIdentifier) = 0;
            ...
            virtual bool WaitForStateChange(TControllerIdentifier controllerIdentifier, SPhysicalState& state, std::stop_token stopToken = std::stop_token()) = 0;
        };

        /// Default implementation of the physical controller communication interface.
        class PhysicalController : public IPhysicalController
        {
        public:
            ...
            SPhysicalState GetCurrentState(TControllerIdentifier controllerIdentifier) override;
            bool WaitForStateChange(TControllerIdentifier controllerIdentifier, SPhysicalState& state, std::stop_token stopToken = std::stop_token()) override;
        };
    }
}
