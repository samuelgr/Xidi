...
namespace Xidi
{
    namespace Mouse
    {
        ...
        private:
            ...
            /// For ensuring proper concurrency control of accesses to the virtual mouse button state represented by this object.
        ...
        /// Manages a thread that continuously runs and updates the physical mouse state from virtual mouse state.
        ...
        public:
            ...
            /// Requires a mouse state contribution tracker object.
            inline MouseUpdateThread(StateContributionTracker& mouseTracker) : mouseUpdateThread(), mouseUpdateStop(), mouseTracker(mouseTracker)
            {
                // Nothing to do here.
            }
        ...
        private:
            ...
            /// @param [in] mouseTracker Pointer to the mouse state contribution tracker object to use for updates.
            /// @param [in] mouseUpdateStopToken Stop token used to indicate that this method should terminate.
            static void UpdatePhysicalMouseState(StateContributionTracker* mouseTracker, std::stop_token mouseUpdateStopToken)
            {
        ...
        public:
            ...
            inline void Start(void)
            {
                ...
                {
                    mouseUpdateThread = std::thread(UpdatePhysicalMouseState, &mouseTracker, mouseUpdateStop.get_token());
                }
            }
        };
