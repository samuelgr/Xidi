 ...
 *   Unit tests for controller element mappers that invert input received
 *   and forward the result to another element mapper.
 *****************************************************************************/
...
namespace XidiTest
{
    ...
    TEST_CASE(InvertMapper_GetTargetElement_Nominal)
    {
        ...
        const InvertMapper mapper(std::make_unique<SplitMapper>(std::make_unique<MockElementMapper>(kUnderlyingElements[0]), std::make_unique<MockElementMapper>(kUnderlyingElements[1])));
    ...
    TEST_CASE(InvertMapper_GetTargetElement_Clone)
    {
        ...
        const InvertMapper mapperOriginal(std::make_unique<SplitMapper>(std::make_unique<MockElementMapper>(kUnderlyingElements[0]), std::make_unique<MockElementMapper>(kUnderlyingElements[1])));
