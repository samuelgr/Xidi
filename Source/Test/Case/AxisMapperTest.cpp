...
namespace XidiTest
{
    ...
    // Creates and then clones one axis mapper for each possible virtual axis and verifies that each correctly identifies its target virtual controller element.
