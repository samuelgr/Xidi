...
/// Logs an error event indicating that an instance of IDirectInput(8) could not be created due to a
/// version out-of-range error.
...
/// Logs an error event indicating that an instance of IDirectInput(8) could not be created due to
...
/// Logs an error event indicating that an instance of IDirectInput(8) could not be created due to
/// an error having been returned by the system.
...
extern "C"
{
  ...
  HRESULT __stdcall ExportApiDirectInputDirectInput8Create(
...
#else
  HRESULT __stdcall ExportApiDirectInputDirectInputCreateA(
  ...
  HRESULT __stdcall ExportApiDirectInputDirectInputCreateW(
  ...
  HRESULT __stdcall ExportApiDirectInputDirectInputCreateEx(
      HINSTANCE hinst, DWORD dwVersion, REFIID riidltf, LPVOID* ppvOut, LPUNKNOWN punkOuter)
  {
    void* diObject = nullptr;
