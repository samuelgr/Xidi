    ...
    namespace Controller
    {
        ...
        static const Mapper kMappers[] = {
            ...
            Mapper(L"StandardGamepad", {
                ...
                .dpadUp = std::make_unique<KeyboardMapper>(VK_UP),
                .dpadDown = std::make_unique<KeyboardMapper>(VK_DOWN),
                .dpadLeft = std::make_unique<KeyboardMapper>(VK_LEFT),
                .dpadRight = std::make_unique<KeyboardMapper>(VK_RIGHT),
